...
<head>
    ...
    <title>Cita Confirmada - TechFix</title>
...
<body>
    <div class="confirm-card">
        ...
        <p>Tu solicitud ha sido registrada y la cita está pendiente de confirmación por el técnico.</p>
        <a href="ListaCitas.php" class="btn-home"><i class="bi bi-calendar-check"></i> Ver mis citas</a>
